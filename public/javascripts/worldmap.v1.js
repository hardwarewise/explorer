...
dataload.forEach(function(d, i) {
    locations.push(d[settings.keys[0]]); 
    var pusher=[];
    settings.keys[1].forEach(function(l, j) {
     pusher.push(d[l]);   
    });
